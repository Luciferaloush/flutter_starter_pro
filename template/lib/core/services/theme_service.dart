  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        // اللون الثانوي الثاني
        surface: Colors.white,
        // خلفية التطبيقات
        error: Colors.red,
        // اللون الخاص بالأخطاء
        onPrimary: Colors.white,
        // اللون عند استخدام الـ primary
        onSecondary: Colors.black,
        // اللون عند استخدام الـ secondary
        onSurface: AppColor.grayColor,
        // اللون عند استخدام الـ background
        onError: Colors.white,
        // اللون عند استخدام الـ error
        brightness: Brightness.light,
        background: Colors.white,
        onBackground: Colors.white, // مستوى السطوع (فاتح أو غامق)
      ),
